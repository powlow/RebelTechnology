...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 534.0, 369.0, 72.0, 22.0 ],
					"text" : "phasor~ 0.5"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "OWL_WarblyDelay.gendsp",
				"bootpath" : "~/Documents/GitHub/RebelTechnology/OWL_WarblyDelay/code",
